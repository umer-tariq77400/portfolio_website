...
SECRET_KEY = 'django-insecure-@6ej4*$yq5z(kyjtd+1bcavf+3tyg#i+%)m2l8nyn2io**ktm5'
...
# For development, we use SQLite3
# For production (Azure), configure PostgreSQL via environment variables
...
# For Azure Blob Storage in production (configure via environment variables)
